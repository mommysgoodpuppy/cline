      ...
      <div
        ...
        <div style={{ marginBottom: 5 }}>
          <VSCodeCheckbox
            ...
            onChange={(e: any) => setAlwaysAllowWriteOnly(e.target.checked)}
          >
          ...
          >
            When enabled, Cline will automatically create and modify files without requiring you to click
            the Approve button. Use with caution as this gives Cline direct write access to your files.
          </p>
        </div>
