...
export class ClineProvider implements vscode.WebviewViewProvider {
	...
	*/
	...
	async initClineWithTask(task?: string, images?: string[]) {
		...
		const { apiConfiguration, customInstructions, alwaysAllowReadOnly, alwaysAllowWriteOnly } = await this.getState()
		this.cline = new Cline(this, apiConfiguration, customInstructions, alwaysAllowReadOnly, alwaysAllowWriteOnly, task, images)
	}
			...
			async (message: WebviewMessage) => {
				switch (message.type) {
					...
					case "alwaysAllowWriteOnly":
						...
						if (this.cline) {
							this.cline.alwaysAllowWriteOnly = message.bool ?? false
						}
						await this.postStateToWebview()
						break
					case "askResponse":
	...
	async getStateToPostToWebview() {
		const { apiConfiguration, lastShownAnnouncementId, customInstructions, alwaysAllowReadOnly, alwaysAllowWriteOnly, taskHistory } =
			await this.getState()
		return {
